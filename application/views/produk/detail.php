                    ...
                    <form>
                      <div class="sizes">
                        ...
                        <?php
                          if($status == 'sold out'){
                        ?>
                          <button class="btn btn-warning" ><i class="fa fa-check"></i>Terjual</button>
                        <?php
                          }else if($status == 'ready'){
                            ?>
                              <button class="btn btn-warning" ><i class="fa fa-check"></i> Akan Datang</button>
                            <?php
                          }else{
                            ?>
                      ...
                      <p class="text-center">
                        <?php
                          ...
                          if($user == ''){
                        ?>
                          <a class="btn btn-template-outlined" href="#" data-toggle="modal" data-target="#login-modal"><i class="fa fa-shopping-cart"></i> Lelang</a>
                        <?php
                          }else{
                            ...
                            if($deposit == ''){
                          ?>
                          <a class="btn btn-template-outlined" href="#" data-toggle="modal" data-target="#deposit-modal"><i class="fa fa-shopping-cart"></i> Lelang</a>
                          <?php
                            }else{
                              if($status == 'sold out'){
                                ?>
                                  <a class="btn btn-template-outlined" href="#" data-toggle="modal" data-target="#soldout-modal"><i class="fa fa-shopping-cart"></i> Lelang/a>
                              <?php
                              }else if($status == 'ready'){
                                ?>
                                  <a class="btn btn-template-outlined" href="#" data-toggle="modal" data-target="#ready-modal"><i class="fa fa-shopping-cart"></i> Lelang</a>
                                <?php
                              }else{
                                if($today <= $exp){
                                  ?>
                                    <a class="btn btn-template-outlined" href="#" data-toggle="modal" data-target="#bid-modal"><i class="fa fa-shopping-cart"></i> Lelang</a>
                                  <?php
                                }else{
                                  ?>
                                    <a class="btn btn-template-outlined" href="#" data-toggle="modal" data-target="#exp-modal"><i class="fa fa-shopping-cart"></i>Lelang</a>
                                  <?php
                                }
                                ?>
              ...
              <div class="row">
                <div class="col-lg-3 col-md-6">
                  <div class="box text-uppercase mt-0 mb-small">
                    <h3>apa kamu suka produk ini?</h3>
                  </div>
                </div>
                <?php
                    ...
                    <div class="product">
                      ...
                      ?>
                        <div class="ribbon-holder">
                          <div class="ribbon new">Terjual</div>
                        </div>
                      <?php
                        }else if($pk->status == 'ready'){
                      ?>
                        <div class="ribbon-holder">
                          <div class="ribbon sale">Segera</div>
                        </div>
                      <?php
                        }else{
                      ?>
                        <div class="ribbon-holder">
                          <div class="ribbon sale">Lelang</div>
                        </div>
                      <?php
                        }
                      ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= base_url('home/bidder') ?>" method="post">
                ...
                <p class="text-center">
                  <button type="submit" class="btn btn-template-outlined"><i class="fa fa-sign-in"></i> Lelang</button>
                </p>
              </form>
        ...
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form>
                <p class="text-center">
                  <a href="<?= base_url('profile') ?>" class="btn btn-template-outlined"><i class="fa fa-sign-in"></i> Deposit Sekarang!!</a>
        ...
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <p class="text-center text-muted"> Mohon maaf, Produk sudah terjual<br> Terimakasih</p>
            </div>
          </div>
        </div>
      </div>
