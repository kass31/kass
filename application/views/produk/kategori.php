      ...
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Kategori <?= $this->uri->segment(3) ?></h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item active">Kategori Berwarna<?= $this->uri->segment(3) ?></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div id="content">
        <div class="container">
          <div class="row bar">
            <div class="col-md-12">
              <p class="text-muted lead text-center"> kami menawarkan berbagai pilihan produk terbaik yang kami temukan dan dipilih dengan cermat di seluruh dunia. .</p>
                  ...
                  ?>
                    <div class="col-lg-3 col-md-4">
                      <div class="product">
                        ...
                        <div class="text">
                          <?php
                            if ($row->tgl_tutup == '2022-05-01'){
                          ?>
                            <button type="button" class="btn btn-warning">Akan Datang</button>
                          <?php
                            }else{
                          ?>
        ...
        <div class="container">
          <div class="col-md-12">
            <div class="heading text-center">
              <h2>Bergabung untuk Pelelang</h2>
            </div>
              ...
              ?>
                <div class="col-md-3">
                  <div data-animate="fadeInUp" class="team-member">
                    ...
                    <a href="<?= base_url('home/produk/').$kategori['url_kategori'].'/'.$row->id_produk ?>" class="btn btn-template-main">Lelang Sekarang</a>
