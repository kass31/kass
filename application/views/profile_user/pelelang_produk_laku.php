            ...
            <div class="col-lg-3 mt-4 mt-lg-0">
              ...
              <div class="panel panel-default sidebar-menu">
                <div class="panel-heading">
                  <h3 class="h4 panel-title">Pelelang Sesi</h3>
                </div>
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="<?= base_url('profile/pelelang/').$id ?>" class="nav-link"><i class="fa fa-user"></i> Profil</a></li>
        ...
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 id="login-modalLabel" class="modal-title">Masukkan Laporan Anda</h4>
            ...
            <div class="modal-body">
              <form id="form" action="<?= base_url('profile/report') ?>" class="form-horizontal" enctype="multipart/form-data" method="post">
                ...
                <p class="text-center">
                  <button type="submit" class="btn btn-template-outlined"><i class="fa fa-sign-in"></i> Report Sekarang</button>
                </p>
              </form>
              <p class="text-center text-muted"> Silahkan isi Laporan ini sesuai dengan pengalaman anda<br> menggunakan aplikasi ini<br> Terimakasih</p>
            </div>
          </div>
        </div>
      </div>