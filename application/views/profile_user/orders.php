                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        ...
                        if($bidder2 == ''){
                          ?>
                        <tr><td colspan="5"><center>belum ada penawaran masuk</center> </td></tr>
                        <?php
                          }else{
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    ...
                    <li class="nav-item"><a href="<?= base_url('profile/orders') ?>" class="nav-link active"><i class="fa fa-list"></i>Order Saya</a></li>
                    <li class="nav-item">
