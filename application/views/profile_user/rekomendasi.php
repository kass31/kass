<?php
  ...
  $sql_payment = "SELECT * FROM abe_invoice WHERE id_user = '$id' AND status = 'belum menyelesaikan pembayaran'";
        ...
        <div class="container">
          <div class="row bar mb-0">
            <div id="customer-orders" class="col-md-9">
              <p class="text-muted lead">Pilih Kategori mana saja yang anda minati agar bisa merekomendasikan untuk anda</p>
            ...
            <div class="col-md-3 mt-4 mt-md-0">
              ...
              <div class="panel panel-default sidebar-menu">
                <div class="panel-heading">
                  <h3 class="h4 panel-title">Customer</h3>
                </div>
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="<?= base_url('profile') ?>" class="nav-link "><i class="fa fa-user"></i> Akun Saya</a></li>
                    <li class="nav-item"><a href="<?= base_url('profile/rekomendasi') ?>" class="nav-link active"><i class="fa fa-list"></i> Bunga Saya </a></li>
                    ...
                    ?>
                        <div class="alert alert-danger" role="alert">
                          <p><center>Saldo Deposit Anda <br>Rp. 0 <br> Silahkan isi terlebih dahulu agar dapat mengikuti lelang ini</center></p>
                        </div>
                        <li class="nav-item"><a href="#" class="nav-link active"><i class="fa fa-money"></i> Tambahkan Deposit</a></li>
                    <?php
                      }else{
                    ?>
