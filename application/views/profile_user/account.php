        ...
        <div class="container">
          <div class="row bar">
            <div id="customer-account" class="col-lg-9 clearfix">
              <p class="lead">Ganti Data Personal</p>
              <p class="text-muted">BIDDER</p>
              <div class="bo3">
                <div class="heading">
                  <h3 class="text-uppercase">Personal detail</h3>
                </div>
                ...
                <form action="<?= base_url('profile/update') ?>" method="post">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input id="firstname" name="firstname" value="<?= $bidder['nama_depan'] ?>" required="" type="text" class="form-control">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="lastname">Nama Belakang</label>
                        <input id="lastname" type="text" name="lastname" value="<?= $bidder['nama_belakang'] ?>" required="" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                      <button type="submit" class="btn btn-template-outlined"><i class="fa fa-save"></i> Simpan Perubahan</button>
                    </div>
                  </div>
                </form>
              </div>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <?php
                        ...
                        if($deposit2 == ''){
                          ?>
                        <tr><td colspan="5"><center>belum ada deposit masuk </center> </td></tr>
                        <?php
                          }else{
            ...
            <div class="col-lg-3 mt-4 mt-lg-0">
              ...
              <div class="panel panel-default sidebar-menu">
                <div class="panel-heading">
                  <h3 class="h4 panel-title">Customer Sesi</h3>
                </div>
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="<?= base_url('profile') ?>" class="nav-link active"><i class="fa fa-user"></i> Akun Saya</a></li>
                    <li class="nav-item"><a href="<?= base_url('profile/rekomendasi') ?>" class="nav-link"><i class="fa fa-list"></i> Bunga Saya</a></li>
                    <li class="nav-item"><a href="<?= base_url('profile/orders') ?>" class="nav-link"><i class="fa fa-list"></i> Order Saya</a></li>
                    <li class="nav-item">
                      <a href="<?= base_url('profile/payment') ?>" class="nav-link"><i class="fa fa-credit-card"></i> Pembayaran
                        <?php
                          if($payment == '0'){
                            echo "";
                          }else{
              ...
              <form action="<?= base_url('profile/deposit') ?>" class="form-horizontal" enctype="multipart/form-data" method="post">
                <div class="form-group">
                  <select class="form-control" name="bank_penerima" required="">
                    ...
                    <option value="BCA - 9876543210">BCA - 98xxxxx</option>
                    <option value="MANDIRI - 9876543210">MANDIRI - 987xxxxx/option>
                    <option value="BNI - 9876543210">BNI - 987xxxxxx</option>
                  </select><br>
                ...
                <p class="text-center">
                  <button type="submit" class="btn btn-template-outlined"><i class="fa fa-sign-in"></i> Deposit Sekarang</button>
                </p>
              </form>
              <p class="text-center text-muted"> Silahkan Transfer Deposit 1 juta Rupiah, untuk mengikuti lelang ini<br> seluruh bank transfer<br> an. <strong> PT Muhi Lelang</strong></p>
            </div>
          </div>
        </div>
      </div>