        ...
        <div class="container">
          <div class="row bar mb-0">
            <div id="customer-orders" class="col-md-9">
              <p class="text-muted lead"> Jika Kamu Punya Pertanyaan <a href="#">kontak</a>,Costumer 24/7.</p>
              ...
              <div class="box">
                ...
                <div class="row addresses">
                  <div class="col-md-6 text-right">
                    <h3 class="text-uppercase"> Alamat Invoice </h3>
                    <p><?= $this->session->userdata('first_name') ?> <?= $this->session->userdata('last_name') ?><br>                   Daerah Istimewa Yogyakarta<br>             Indonesia</p>
                  </div>
                  <div class="col-md-6 text-right">
                    <h3 class="text-uppercase"> Alamat Shipping </h3>
                    <p><?= $this->session->userdata('first_name') ?> <?= $this->session->userdata('last_name') ?><br>                   Daerah Istimewa Yogyakarta<br>          Indonesia</p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="<?= base_url('profile') ?>" class="nav-link "><i class="fa fa-user"></i> Akun Saya</a></li>
                    ...
                    <li class="nav-item">
                      <a href="<?= base_url('profile/payment') ?>" class="nav-link active"><i class="fa fa-credit-card"></i> Pembayaran
                        <?php
                          if($payment == '0'){
                            echo "";
                          }else{
        ...
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <p class="text-center text-muted"> Silahkan Transfer Sesuai Harga Total, termasuk 3 (tiga) digit terakhir<br> seluruh bank transfer<br> an. <strong> PT Muhi Lelang</strong></p>
            </div>
          </div>
        </div>
      </div>
