        ...
        <div class="container">
          <section class="bar">
            <div class="row">
              <div class="col-lg-12">
                <div class="heading">
                  <h2>Proses Cara Mengikuti Lelang</h2>
                </div>
                <!--<p class="?"</p>-->
              </div>
            </div>
        ...
        <!--<section class="bar bg-gray">
          <div class="container">
            <div class="heading text-center">
              <h2>Our Big Costumer</h2>
            </div>
            <ul class="list-unstyled owl-carousel customers no-mb">
              <li class="item"><img src="<?= base_url('assets/front_end/') ?>img/customer-1.png" alt="" class="img-fluid"></li>
              <li class="item"><img src="<?= base_url('assets/front_end/') ?>img/customer-2.png" alt="" class="img-fluid"></li>
              <li class="item"><img src="<?= base_url('assets/front_end/') ?>img/customer-3.png" alt="" class="img-fluid"></li>
              <li class="item"><img src="<?= base_url('assets/front_end/') ?>img/customer-4.png" alt="" class="img-fluid"></li>
              <li class="item"><img src="<?= base_url('assets/front_end/') ?>img/customer-5.png" alt="" class="img-fluid"></li>
              <li class="item"><img src="<?= base_url('assets/front_end/') ?>img/customer-6.png" alt="" class="img-fluid"></li>
            </ul>
          </div>
        </section>-->
                    ...
                    <div class="testimonial d-flex flex-wrap">
                      ...
                      <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                        ...
                        <div class="testimonial-info d-flex">
                          ...
                          <div class="avatar"><img alt="" src="<?= base_url('assets/front_end/') ?>img/person-1.jpg" class="img-fluid"></div>
                        </div>
                      </div>
                    </div>
                  </li>
                    ...
                    <div class="testimonial d-flex flex-wrap">
                      ...
                      <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                        ...
                        <div class="testimonial-info d-flex">
                          ...
                          <div class="avatar"><img alt="" src="<?= base_url('assets/front_end/') ?>img/person-2.jpg" class="img-fluid"></div>
                        </div>
                      </div>
                    </div>
                  </li>
                    ...
                    <div class="testimonial d-flex flex-wrap">
                      ...
                      <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                        ...
                        <div class="testimonial-info d-flex">
                          ...
                          <div class="avatar"><img alt="" src="<?= base_url('assets/front_end/') ?>img/person-3.png" class="img-fluid"></div>
                        </div>
                      </div>
                    </div>
                  </li>
                    ...
                    <div class="testimonial d-flex flex-wrap">
                      ...
                      <div class="bottom d-flex align-items-center justify-content-between align-self-end">
                        ...
                        <div class="testimonial-info d-flex">
                          ...
                          <div class="avatar"><img alt="" src="<?= base_url('assets/front_end/') ?>img/person-4.jpg" class="img-fluid"></div>
                        </div>
                      </div>
                    </div>
                  </li>
