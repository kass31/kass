...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>E</b>Lelang</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>E</b>Lelang</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <small>Member <?= date('F ,Y',strtotime($tgl)) ?></small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?= base_url() ?>dashboard/profile_<?= $hak_akses ?>" class="btn btn-default btn-flat">Profil</a>
                </div>
  ...
  <marquee>  <strong>Copyright &copy; 2021 <a href="#">E-Lelang Pungkas</a> </marquee>
  </footer>
