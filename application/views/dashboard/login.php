...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>E</b>Anggota</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Masuk Untuk Memulai Sebagai Anggota</p>
    ...
    <form action="<?= base_url('dashboard/proses_login') ?>" method="post">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat"><i class="fa fa-key" ></i> Masuk</button>
