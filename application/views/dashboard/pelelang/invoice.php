...
<html>
  <head>
    ...
    <title>E Muhi - Lelang Online</title>
        ...
        <div class="container">
          <div class="row d-flex align-items-center">
            <div class="col-md-6 d-md-block d-none">
              <p>Hubungi di 0878 xxxx xxx pungkasw35@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
      <div id="heading-breadcrumbs">
        <div class="container">
          <div class="row d-flex align-items-center flex-wrap">
            <div class="col-md-7">
              <h1 class="h2">Order ku</h1>
            </div>
            <div class="col-md-5">
              <ul class="breadcrumb d-flex justify-content-end">
                <li class="breadcrumb-item"><a href="#">Profil</a></li>
                <li class="breadcrumb-item active">Order ku</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row bar mb-0">
            <div id="customer-orders" class="col-md-9">
              <p class="text-muted lead">Jika Kamu punya Pertanyaan <a href="#">hubungi</a>, costumer service</p>
              <div class="box">
                <?php
                ...
                <div class="table-responsive">
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        <th colspan="2" class="border-top-0">Produk</th>
                        <th class="border-top-0">Kualitas</th>
                        <th class="border-top-0">Harga Unit</th>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3">
              <h4 class="h6">Call Me</h4>
                <p class="text-uppercase">
                  <strong>
                    <i class="fa fa-phone"></i> 0878 xxxx xxxx<br>
                    <i class="fa fa-envelope-o"></i> pungkasw35@gmail.com<br>
                    <i class="fa fa-shopping-basket"></i> E Muhi
                  </strong>
                </p>
            ...
            <div class="col-lg-3">
              ...
              <p class="text-uppercase"><strong>E Muhi</strong><br> NITIKAN <br>SMK Muhammadiyah <br> bantul<br>YOGYAKARTA <br><strong>Indonesia</strong></p><a href="#" class="btn btn-template-main">Go to contact page</a>
              <hr class="d-block d-lg-none">
            </div>
            <div class="col-lg-3">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-4 text-center-md">
                <p>&copy; 2020 lelangonline/ pungkas wahyu</p>
              </div>
              <div class="col-lg-8 text-right text-center-md">
                <p>Template design by <a href="https://bootstrapious.com/free-templates">Bootstrapi Template </a></p>
              </div>
            </div>
          </div>
        </div>
