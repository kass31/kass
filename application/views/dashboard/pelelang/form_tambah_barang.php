      ...
      <div class="row">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              ?> 
                ...
                <p><i><strong>note : </strong><br>Foto yang di perbolehkan upload dengan format( jpg / png / jpeg )<br>Size maks 1 Mb</i></p>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-xs-7">
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('back_end/barang/save_produk'); ?>">
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-4 control-label">Kategori Produk</label>
                  <div class="col-sm-8">
                    <select name="kategori" required="true" class="form-control">
                      <option value="">-- pilih kategori produk --</option>
                      <?php
                        $sql = "SELECT * FROM abe_kategori";
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" required="true" name="nama" placeholder="nama produk">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Harga Produk</label>
                  <div class="col-sm-8">
                    <input type="text" id="harga" class="form-control" required="true" name="harga" placeholder="harga minimal produk">
                  </div>
                </div>
                <div class="form-group">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-save"></i> Proses</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
              <form action="#" id="form"  class="form-horizontal">
                ...
                <input type="hidden" value="0" name="id_produk"/> 
                <div class="form-body">
                  <div class="form-group">
