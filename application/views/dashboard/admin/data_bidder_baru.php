          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="mytable" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php
                    $sql    = "SELECT * FROM users WHERE status = 'daftar' ORDER BY id DESC";
                    ...
                    foreach ($bidder as $row) {
                        ...
                        echo "<tr>
                            ...
                            <td>$row->email</td>
                            <td>$row->status</td>
                            <td><a title='Aktifkan Bidder' class='btn btn-xs btn-success btn-flat' href='".base_url()."back_end/users/aktifkan_bidder/$id'><i class='fa fa-check'></i> Aktifkan</a></td></tr>";     
                          $no++;
                      }
                  ?>
                </tbody>
