      ...
      <footer class="main-footer">
        <div class="container">
          <div class="row">
            <div class="col-lg-3">
              <h4 class="h6">UKK</h4>
              <p>PUNGKAS WAHYU ARDIYANSYAH<br>4316<br>Rekayasa Perangkat Lunak<br>SMK Muhammadiyah 1 Yogyakarta</p>
              <hr>
            </div>
            <!--<div class="col-lg-3">
              <h4 class="h6">Contact</h4>
                <p class="text-uppercase">
                  <strong>
                    <i class="fa fa-phone"></i> 0823 xxxx xxxx<br>
                    <i class="fa fa-envelope-o"></i> pungkaswahyu@gmail.com<br>
            ...
            <!--<div class="col-lg-3">
              ...
              <p class="text-uppercase"><strong>E Muhi.</strong><br>Gg. Merpati <br>No 155 <br>Banguntapan <br>Daerah Istimewa Yogyakarta <br><strong>Indonesia</strong></p><a href="<?= base_url('home/kontak') ?>" class="btn btn-template-main">Go to contact page</a>
              <hr class="d-block d-lg-none">
            </div>-->
            <!--<div class="col-lg-3">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-4 text-center-md">
                <p>&copy; 2020 lelangonline/ pungkas wahyu / PUNGKASWAHYU UKK</p>
              </div>
              <div class="col-lg-8 text-right text-center-md">
                <p>Template design by Bootstraps & figma</a></p>
              </div>
            </div>
          </div>
        </div>
