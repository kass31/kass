...
class Dashboard extends CI_Controller {
    ...
    public function proses_daftar()
    {
        ...
        if ($cek_email > 0){
            ...
            $config['smtp_host']= "pugkasw35@gmail.com";
            $config['smtp_timeout']= "400";
            $config['smtp_user']= "pungkasw35@gmail.com"; // isi dengan email kamu
            $config['smtp_pass']= "Ketadan03"; // isi dengan password kamu
            $config['crlf']="\r\n"; 
            $config['newline']="\r\n"; 
            ...
            $this->email->message(
                "<h1>E-Lelang</h1> Terimakasih telah melakuan registrasi, untuk memverifikasi akun anda silahkan klik tautan dibawah ini<br><br>".
    ...
    public function proses_forgot()
    {
        ...
        if ($cek_email == 0){
            ...
            $config['protocol']= "smtp";
            $config['mailtype']= "html";
            $config['smtp_host']= "pungkasw35@gmail.com";//pengaturan smtp
            $config['smtp_port']= "587";
            $config['smtp_timeout']= "400";
            $config['smtp_user']= "pungkasw35@gmail.com"; // isi dengan email kamu
            $config['smtp_pass']= "Ketandan03"; // isi dengan password kamu
            $config['crlf']="\r\n"; 
            $config['newline']="\r\n"; 
            $config['wordwrap'] = TRUE;
            ...
            $this->email->message(
                "<h1>E-Lelang</h1> Terimakasih telah melakukan reset password, untuk mereset password anda silahkan klik tautan dibawah ini<br><br>".
    ...
    {
        $id = $this->session->userdata('id_user');
        $data['record'] = $this->M_dashboard->profile_admin($id)->row_array();
        $this->template->load('template_back','dashboard/admin/profile_pelelang',$data);
    ...
    {  
        ...
        $this->M_dashboard->update_administrator($data, $user);
        $this->session->set_flashdata('sukses','Data admin Berhasil Di update');
        redirect('dashboard/profile_administrator');
    }
